...
jQuery(document).ready(function($) {
    var alterClass = function() {
        ...
        if (ww < 575) {
            $('.to-check').addClass('blank-space-50');
        } else if (ww >= 575) {
            $('.to-check').removeClass('blank-space-50');
        };
        if (ww < 1025) {
            $('.lmpixels-arrows-nav').removeClass('display-none');
        } else if (ww >= 1025) {
            $('.lmpixels-arrows-nav').addClass('display-none');
